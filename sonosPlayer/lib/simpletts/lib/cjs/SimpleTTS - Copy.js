...
// Only mbrola
const tmpVoices = (0, node_path_1.resolve)(__dirname, '../../batchs', platform, 'tmp');
// special voices, linux (mbrola)
const Jsonvoices = (0, node_path_1.resolve)(__dirname, '../../batchs', platform, 'voices/voices.json');
                    ...
                    return this._forceStop ? options : Promise.resolve().then(() => {
                        ...
                        return new Promise((resolve, reject) => {
                            ...
                            if (platform === 'win32') {
                                ...
                                node_exist_1.chmodSync(script, "755");
                            }
